...
void zaman::sat_turk_v_d()
{
	...
	// ⚡ Bolt Optimizasyonu: .append() yerine snprintf ile dogrudan formatlama
	// Bellek sizintisini/sinirsiz buyumeyi engeller ve saniye/dakika icin dogru sifir-dolgusu (zero-padding) saglar.
	char buffer[32];

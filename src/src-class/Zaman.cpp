...
std::string zaman::td_to_vakt(unsigned int td)
{
	...
	// stack tabanlı char buffer ve snprintf kullanımı geçici bellek tahsislerini
	// azaltır ve performansı artırır. Ayrıca dakika için %02d ile sıfır dolgusu sağlar.

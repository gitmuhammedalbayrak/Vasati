...
{
	// ⚡ Bolt Optimizasyonu: std::to_string ve string birleştirme işlemlerinden kaynaklanan heap allocation
	// yükünü önlemek için sabit boyutlu buffer ve std::snprintf kullanıldı.
	char buf[16];
...
void zaman::sat_turk_v_d()
{
	...
	zaman::simdiki_zaman_turk = std::string(buf);
